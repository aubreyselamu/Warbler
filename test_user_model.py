...
class UserModelTestCase(TestCase):
    ...
    def test_user_follows(self):
        ...
        self.assertEqual(self.u2.follower[0], self.u1.id)
        self.assertEqual(self.u1.following[0], self.u2.id)
    ...
    def test_valid_signup(self):
        u_test = User.signup('testing', 'testing@gmail.com', 'password', None)
        uid = 999
        u_test.id = uid
        db.session.commit()
        ...
        self.assertEqual(u_test.email, 'testing@gmail.com')
